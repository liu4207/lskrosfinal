...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/liu/桌面/lskros_ws/src/test2)
  set(test2_DEVEL_PREFIX /home/liu/桌面/lskros_ws/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/liu/桌面/lskros_ws/install)
...
if(NOT "/home/liu/桌面/lskros_ws/src/test2/include " STREQUAL " ")
  set(test2_INCLUDE_DIRS "")
  set(_include_dirs "/home/liu/桌面/lskros_ws/src/test2/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liu/桌面/lskros_ws/src/test2/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(test2_EXPORTED_TARGETS ${${test2_dep}_EXPORTED_TARGETS})
endforeach()
